  ...
  return (
    <div className="content-wrap">
      <Jumbotron className="jumbotron-page-alt-contact">
        <h1>
          Contact Form <FontAwesomeIcon icon={['fas', 'feather-alt']} />
        </h1>
        <hr />
        <h2>
          To send a message to the Fortune Cuttlefish or the human programmer of
          this site, fill out and submit this contact form.
        </h2>
